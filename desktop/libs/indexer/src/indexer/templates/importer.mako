        ...
        <div class="card step">
          ...
          <div class="card-body">
            ...
            <label for="tablePartitions" class="control-label"><div>${ _('Partitions') }</div>
              ...
              <a data-bind="click: function() { partitionColumns.push($root.loadDefaultField({isPartition: true})); }" class="pointer margin-left-20" title="${_('Add Partition')}"><i class="fa fa-plus"></i> ${_('Add partition')}</a>              
              <!-- /ko -->
